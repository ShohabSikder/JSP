...
<form class="container" action="edit.jsp" method="post" >
    <input type="hidden" class="form-control" id="id" name="id" value="<%=s.getId()%>" >
    <div class="row">
        <div class="col-md-6">
            <label  class="form-label">First Name</label>
            <input type="text" class="form-control" id="FirstName" name="firstName" value="<%=s.getFirstName()%>" placeholder="First Name">
        </div>
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            ...
            <select class="form-select" aria-label="Default select example" name="subject" value="<%=s.getSubject()%>">
